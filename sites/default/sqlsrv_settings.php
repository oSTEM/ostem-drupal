...
$azure_db_conn_str = getenv("SQLAZURECONNSTR_sqlsrvdb");
$azure_db_conn_array = array();
$parts = explode(";", $azure_db_conn_str);
foreach($parts as $part){
    $temp = explode("=", $part);
    $azure_db_conn_array[$temp[0]] = $temp[1];
}

$databases['default']['default'] = array(
    'driver' => 'sqlsrv',
    'database' => $azure_db_conn_array['Initial Catalog'],
    'username' => $azure_db_conn_array['User ID'],
    'password' => $azure_db_conn_array['Password'],
    'host' => $azure_db_conn_array['Data Source'],
    'prefix' => '',
);
